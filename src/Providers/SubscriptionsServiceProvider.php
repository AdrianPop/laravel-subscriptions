...
class SubscriptionsServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Publish Resources
        $this->publishesConfig('ipop/rinvex-laravel-subscriptions');
        $this->publishesMigrations('ipop/rinvex-laravel-subscriptions');
        ! $this->autoloadMigrations('ipop/rinvex-laravel-subscriptions') || $this->loadMigrationsFrom(__DIR__.'/../../database/migrations');
    }
}
